...
<body class="dark-purple-drinks">
    ...
    <div class="row purple-gradient" id="fixToTop" style='color: antiquewhite'>    
        ...
        <div class="col navbarHover" type="button" onclick="location.href='<?= site_url($controller."/search") ?>'" style='text-align: center; padding: 20px;'>
            <a href="<?= site_url($controller."/search") ?>"><i class="fa fa-search" aria-hidden="true"></i></a>
        </div>
